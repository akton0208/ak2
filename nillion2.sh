...
# 運行新的 Docker 容器
docker run -d --name nillion_verifier -v ./nillion/accuser:/var/tmp nillion/retailtoken-accuser:v1.0.1 accuse --rpc-endpoint "https://nillion-testnet-rpc.polkachu.com" --block-start $latest_block_height
# 顯示 Docker 容器的最新日誌
